...
public class ServerConnectionStateAwaitingClientHandshake : FsmState<ServerSideConnectionHandler>, 
    IEventReceiver<ClientHandshake>
{
    ...
    public void On(ClientHandshake handshake)
    {
        ...
        try
        {
            ...
            agent.fsm.ChangeState<ServerConnectionStateAwaitingClientJoinRequest>();
        }
